...
from dlkit.modules.func import log_sum_exp, enumerate_discrete
from dlkit.modules.distributions import log_standard_categorical
...
class SVI(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        # Equivalent to -U(x)
        U = L + H
        return -torch.mean(U), reconstruction
